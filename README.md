...
|<p align="left">- 로그인 등 인증 처리<br/>(JWT 발급,인증)<br/>- OAuth2 로그인 <br/>인증 처리(Google)<br/>- 질문 등록,조회,삭제<br/>투표 관리 기능<br/>- 답변 등록,조회삭제<br/>투표 관리 기능<br/>- 예외처리 로직 구현<br/>- 게시글,답변 유효성<br/>검증 처리 구현<br/>- 프로필 이미지 관리<br/>-JUnit 계층 초안작성<br/>(Security,Stub Data)<br/>- 배포환경 구축</p>|<p align="left">- 메인화면 API <br/>- 게시글 검색 기능<br/>- 게시글 정렬 기능 <br/>- User 화면 조회기능<br/>페이지네이션 구현<br/>- Tag 화면 조회가눙<br/>페이지네이션 구현<br/>- User,Tags 검색기능<br/>- 회원 프로필 게시글<br/>댓글 조회기능<br/>- 배포환경 구축</p>|<p align="left">- 회원 등록,삭제<br/>- 프로필 조회,수정<br/>삭제,편집 기능구현<br/>- 회원가입 유효성 체크<br/>- 시간관리 기능 추가<br/>- 배포환경 구축</p>|<p align="left"><br/>-Main 페이지 구현<br/>(검색, 정렬 조회)<br/>-Users 페이지 구현<br/>(검색 기능)<br/>-Tags 페이지 구현<br/>(검색 기능)<br/>-페이지네이션 구현<br/>-Sign up 페이지 및 <br/> 구글 OAuth2.0 <br/>회원가입 구현<br/>-Right Sidebar <br/>컴포넌트 구현</p>|<p align="left">-Header<br/>컴포넌트 구현 <br/>-Left Nav <br/>컴포넌트 구현 <br/>-Post 페이지 구현 <br/>(조회,삭제,공유,투표) <br/>-유저 Profile <br/>페이지 구현  <br/>-Login 페이지 구현<br/>(JWT 이용 - 일반 로그인 <br/> OAuth 2.0 로그인) <br/>-모바일, 태블릿 사이즈 <br/>반응형 웹 작업 </p>|<p align="left">- Footer <br/>컴포넌트 작업 <br/>- 404 Not Found<br/>Page 작업</p> |
